			...
			<div class="main-titlebar-window-controls main-titlebar-standard-controls">
				{(() => {
					if (props.os != "darwin") {
						return (
							<>
								<button tabindex="-1" id="minimize-button">
								...
								<button tabindex="-1" id="maximize-button">
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" width="14px" height="14px">
										<rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
									</svg>
								</button>
								<button tabindex="-1" id="close-button">
